...
% ==============================================================================
% Problem: Footnotes not appearing in PDF output
% Solution: Convert all footnotes to endnotes that appear at document end
...
\renewcommand{\notesname}{References}  % Change "Notes" to "References"
\renewcommand{\enotesize}{\footnotesize}  % Smaller font for endnotes
