...
**Date:** 2015-08-14T05:23:58+00:00
**Author:** S J
**Source:** https://netstrata.com.au/proposed-changes-to-strata-legislation/

---

After a comprehensive review that began in December 2011, the NSW state government has released the final draft of their proposed changes to strata legislation. The government is now embarking on the last stage of public consultation before the bills are passed into law.
...
Overall the Department of Fair Trading, as stated on its website, aim to:
...
The bill will also stipulate the procedure for the renewal process including the establishment of a dedicated committee.

#### Limit on proxy votes

There will now be a limit on the amount of proxy votes that one owner can hold. In strata schemes that have less than 20 lots, each owner will only be allowed to have one proxy vote. In schemes with more than 20 lots, each owner can have no more than five per cent of the total number of lots.
...
#### New building defect procedure

There will now be new procedures for the rectification of building defects in newly completed strata schemes. If the initial defect period for the scheme has expired, the owner can now appoint an independent building consultant to undertake a defect inspection. An interim report must be completed between 12 and 18 months after the scheme began. The final report must be completed between 18 and 24 months after the scheme began.
...
Developers must now put down a building bond prior to the completion of the building work. The bond amount must be two per cent of the contract price for the building work. This bond is to secure funding for the rectification of defective building work that is identified in the final inspection report. This bond can be claimed by the owner or the Owners Corporation two years after completion of within 60 days of the final report being issued.
